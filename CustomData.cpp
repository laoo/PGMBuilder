...
static const SIGS025Settings<1> drgw3j_igs025_data =
{
	.nVariant = VAR_DRAGON_WORLD_3,
	.nDefaultRegion = 0x01, // Japan
	.aRegionTable = 
	{{
		// region 1, Japan, $14c21a
		{
...
static const SIGS025Settings<7> olds_igs025_data =
{
	.nVariant = VAR_ORIENTAL_LEGEND_SUPER,
	.nDefaultRegion = 6, // world
	.aRegionTable = 
	{{
		{
			.nRegionCode = 1,
			.anGameId = { 0x00, 0x90, 0x00, 0x01 },
			.anTable =
			{ // region 1, $1A669A, Taiwan
		...
		{
			.nRegionCode = 2,
			.anGameId = { 0x00, 0x90, 0x00, 0x02 },
			.anTable =
			{ // region 2, $19A5F8, China
		...
		{
			.nRegionCode = 3,
			.anGameId = { 0x00, 0x90, 0x00, 0x03 },
			.anTable =
			{ // region 3, $1F9508, Japan
		...
		{
			.nRegionCode = 4,
			.anGameId = { 0x00, 0x90, 0x00, 0x04 },
			.anTable =
			{ // region 4, $1CA7B8, Korea
		...
		{
			.nRegionCode = 5,
			.anGameId = { 0x00, 0x90, 0x00, 0x05 },
			.anTable =
			{ // region 5, $1A19FA, Hong Kong
		...
		{
			.nRegionCode = 6,
			.anGameId = { 0x00, 0x90, 0x00, 0x06 },
			.anTable =
			{ // region 6, $2937EA, World
		...
		{
			.nRegionCode = 7,
			.anGameId = { 0x00, 0x90, 0x00, 0x07 },
			.anTable =
			{ // region 7, $255E8C, World duplicate?
...
std::span<const uint8_t> getCustomDataIGS025( std::string const& gameName )
{
	...
	if (gameName == "drgw3100" || gameName == "drgw3103")
		return staticDataToSpan(&drgw3j_igs025_data);
	...
	if (gameName.starts_with("olds") && !gameName.starts_with("oldsplus"))
		return staticDataToSpan(&olds_igs025_data);
